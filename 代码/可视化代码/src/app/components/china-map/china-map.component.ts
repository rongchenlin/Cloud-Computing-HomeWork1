...
export class ChinaMapComponent implements OnInit {
  ...
  private loadMap() {
    ...
    this.httpClient.get('assets/data/china.json').subscribe((jsonData: any[]) => {
      ...
      jsonData = jsonData.sort((o1, o2) => o1.user - o2.user);
      jsonData.forEach(o => popularJson.push({name: o.city, value: o.user}));
      this.mapOption = {
        // 进行相关配置
        title: {
          text: '中国各省Java使用者',
      ...
      setInterval(() => {
        this.chinaJavaOption = (this.chinaJavaOption === this.mapOption ? this.barOption : this.mapOption);
